## TODO: accommodate horizontal labeling of colors
...
#' @param print.label logical, print Munsell color labels inside of rectangles, when they fit 
...
#' @param print.n.hz optionally print the number of horizons

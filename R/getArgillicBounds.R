...
#' @title Estimate upper and lower boundary of argillic diagnostic subsurface horizon
#'
...
#' @title Determines threshold (minimum) clay content for argillic upper bound
#'
...
#' @title Get depth where clay increase for argillic horizon is met
#'
#' Returns the top depth of the argillic horizon as a numeric vector. This is the depth where the clay content increases by `[crit.clay.argillic()]` over a vertical distance of `30` centimeters or less.
#'

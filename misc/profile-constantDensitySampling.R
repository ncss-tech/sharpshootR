...
# 
# 642 seconds
system.time(ss <- constantDensitySampling(s, n.pts.per.ac=1, parallel = FALSE))
# 790 seconds
system.time(ss <- constantDensitySampling(s, n.pts.per.ac=1, parallel = TRUE))
...
# profile
pd.1 <- profileExpr(ss <- constantDensitySampling(s, n.pts.per.ac=0.1, parallel = TRUE))
pd.2 <- profileExpr(ss <- constantDensitySampling(s, n.pts.per.ac=0.1, parallel = FALSE))
